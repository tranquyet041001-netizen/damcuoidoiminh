  ...
  return (
    <section id="story" className="py-16 px-4 bg-sage-texture relative overflow-hidden">
      <div className="max-w-xl mx-auto relative z-10">
        ...
        {/* Timeline List */}
        <div className="relative pl-6 sm:pl-8 space-y-8 before:absolute before:left-2 sm:before:left-3 before:top-3 before:bottom-3 before:w-[2px] before:bg-gradient-to-b before:from-[#4A6741]/40 before:via-[#C4715A]/40 before:to-[#C9A84C]/40">
          {weddingData.story.map((milestone, index) => (
            ...
            >
              {/* Dot trên timeline */}
              <div className="absolute -left-[29px] sm:-left-[37px] top-4 w-4 h-4 rounded-full bg-[#FDFAF5] border-2 border-[#4A6741] flex items-center justify-center shadow-xs">
                <div className="w-1.5 h-1.5 rounded-full bg-[#C4715A]" />
              </div>

              {/* Card nội dung */}
              <div className="rounded-2xl p-5 bg-[#FFFDF9] border border-[#E8D5CF]/80 shadow-xs hover:shadow-md transition-shadow">
