  ...
  return (
    <section id="details" className="relative py-16 sm:py-24 px-3 sm:px-6 overflow-hidden select-none" style={{ backgroundColor: "#140406" }}>
      ...
      <div className="max-w-xl md:max-w-4xl lg:max-w-5xl mx-auto relative z-10">
        ...
        {/* ── DANH SÁCH 2 SỰ KIỆN: LỄ THÀNH HÔN & TIỆC CƯỚI MỪNG ── */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {weddingData.events.map((event, index) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="relative rounded-3xl p-6 sm:p-8 border-2 border-[#E5C368]/80 shadow-[0_20px_45px_-10px_rgba(0,0,0,0.8),0_0_25px_rgba(229,195,104,0.2)] overflow-hidden flex flex-col justify-between"
              style={{
                background: "linear-gradient(165deg, #240507 0%, #180305 60%, #100203 100%)",
              }}
            >
              ...
              <div>
                ...
                <div className="flex items-center justify-between gap-2 pb-4 mb-5 border-b border-[#E5C368]/40">
                  ...
                  <div className="px-3.5 py-1.5 rounded-full bg-[#3B090D] border border-[#E5C368] text-[#FDE68A] text-xs font-serif font-bold flex items-center gap-1.5 shadow-md">
              ...
              <div className="pt-6 mt-6 border-t border-[#E5C368]/30 flex flex-wrap gap-2.5">
                <a
                  href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(`${event.venue} ${event.address}`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-full text-xs font-serif font-bold text-[#FDFAF5] transition-all transform active:scale-95 hover:scale-102 cursor-pointer shadow-md"
                  style={{
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center gap-1.5 py-2.5 px-4 rounded-full text-xs font-serif font-bold text-[#FFF3B0] bg-[#3B090D] hover:bg-[#4E0D12] border border-[#E5C368]/70 transition-all transform active:scale-95 cursor-pointer shadow-md"
                >
